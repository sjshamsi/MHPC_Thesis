#!/bin/bash -l
#SBATCH --job-name=scale2_hidden640_depth12_mlp2048
...
srun python -u `which torchrun` \
    ...
    --rdzv_endpoint=$SLURMD_NODENAME:29500 \
        train.py distribution=ddp server=leonardo data=smallset_leonardo \
            ...
            name=scale2_hidden640_depth12_mlp2048 trainer.grad_acc_steps=4 optimizer=adam optimizer.lr=0.0002 \
            ...
            model.projection_dim=48 model.intermediate_dim=352 model.hidden_dim=640 model.groups=16 \

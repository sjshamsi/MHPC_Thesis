...
# (hidden_dim=1088, processor_blocks=30, mlp_dim=4352) and same data=Leonardo_smallest8_2_3d
...
#
# Everything else (data=Leonardo_smallest8_2_3d, max_samples=2000, max_epoch=71,

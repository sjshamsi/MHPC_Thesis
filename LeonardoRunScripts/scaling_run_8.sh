#!/bin/bash -l
#SBATCH --job-name=scale8_hidden768_depth14_mlp2048
...
srun python -u `which torchrun` \
    ...
    --rdzv_endpoint=$SLURMD_NODENAME:29500 \
        train.py distribution=ddp server=leonardo data=smallset_leonardo \
            ...
            name=scale8_hidden768_depth14_mlp2048 trainer.grad_acc_steps=4 optimizer=adam optimizer.lr=0.0002 \
            ...
            model.processor_blocks=14 model.drop_path=0.1 \

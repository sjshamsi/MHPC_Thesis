...
# same data=Leonardo_smallest8_2_3d (all 6 datasets), spread across --nodes=4 (16 GPUs)
...
# properly continued.
#
# Everything else (model.* architecture, data=Leonardo_smallest8_2_3d, max_samples=2000,

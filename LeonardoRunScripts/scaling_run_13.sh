#!/bin/bash -l
#SBATCH --job-name=scale13_hidden768_depth12_mlp3072
...
srun python -u `which torchrun` \
    ...
    --rdzv_endpoint=$SLURMD_NODENAME:29500 \
        train.py distribution=ddp server=leonardo data=smallset_leonardo \
            ...
            name=scale13_hidden768_depth12_mlp3072 trainer.grad_acc_steps=4 optimizer=adam optimizer.lr=0.0002 \
            ...
            model/processor/space_mixing=full_spatial_attention model.processor.space_mixing.mlp_dim=3072 \

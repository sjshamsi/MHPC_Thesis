#!/bin/bash -l
#SBATCH --job-name=halfDims_activematter_BS500
...
# `./submit.sh --export=ALL,AUTO_RESUME=False halfDims_activematter_BS500.sh`) to force a
...
srun python -u `which torchrun` \
    ...
    --rdzv_endpoint=$SLURMD_NODENAME:29500 \
        train.py \
            ...
            name=halfDims_activematter_BS500 \
            trainer=defaults \
            ...
            data.module_parameters.max_samples=500 \

...
#SBATCH --mem=0
#SBATCH --exclusive
#SBATCH -J star11_lr0.00025_40_hidden1408_mlp_2872 
#SBATCH --output=slurmid%j-star11_lr0.00025_40_hidden1408_mlp_2872.log
#SBATCH -C h100|h200
...
srun --export=ALL env LD_LIBRARY_PATH=$LD_LIBRARY_PATH \
		...
		--rdzv_endpoint=$SLURMD_NODENAME:29500 \
			train.py distribution=fsdp ++experiment_dir=/mnt/home/polymathic/ceph/MPPX_logging/runs name=star11_lr0.00025_40_hidden1408_mlp_2872_peval trainer.grad_acc_steps=5 server=rusty experiment=validate_example checkpoint=defaults optimizer=adam optimizer.lr=0.00025 logger.wandb_project_name="MPPX_Scaling" \
				...
				model/processor/space_mixing=full_spatial_attention model.processor.space_mixing.mlp_dim=2872 model.processor.space_mixing.num_heads=16 model.processor.time_mixing.num_heads=16 \
				...
				checkpoint.coalesced_checkpoint_path="/mnt/home/polymathic/ceph/MPPX_logging/runs/star11_lr0.00025_40_hidden1408_mlp_2872_peval-wella-delta-Isotr\\[Space-Adapt-Space-FullA-Axial\\]-AdamW-0.00025/0/checkpoints/coalesced.pth"

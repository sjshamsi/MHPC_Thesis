...
source /mnt/home/mmccabe/venvs/mppx_static/bin/activate
...
\t\t\ttrain.py distribution=ddp ++experiment_dir=/mnt/home/polymathic/ceph/MPPX_logging/runs name=grid{count}_lr{lr}_{depth}_hidden{hidden_dim}_mlp_{mlp} trainer.grad_acc_steps=4 server=gpuxl optimizer=adam optimizer.lr={lr} logger.wandb_project_name="MPPX_Scaling_Grid" \\
...
\t\t\t\ttrainer.prediction_type="delta" data=all_2_3d trainer.max_epoch=120 data_workers=6 model.override_dimensionality=0 auto_resume=True 
"""

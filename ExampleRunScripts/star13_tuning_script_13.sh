...
#SBATCH --mem=0
#SBATCH --exclusive
#SBATCH -J star13_lr0.00025_40_hidden1408_mlp_1830_eval 
#SBATCH --output=validate_slurmid_eval%j-star13_lr0.00025_40_hidden1408_mlp_1830.log
#SBATCH -C h100|h200
...
srun --export=ALL env LD_LIBRARY_PATH=$LD_LIBRARY_PATH \
		...
		--rdzv_endpoint=$SLURMD_NODENAME:29500 \
			train.py distribution=fsdp ++experiment_dir=/mnt/home/polymathic/ceph/MPPX_logging/runs name=star13_lr0.00025_40_hidden1408_mlp_1830_peval trainer.grad_acc_steps=5 server=rusty experiment=validate_example checkpoint=defaults optimizer=adam optimizer.lr=0.00025 logger.wandb_project_name="MPPX_Scaling" \
				...
				checkpoint.coalesced_checkpoint_path="/mnt/home/polymathic/ceph/MPPX_logging/runs/star13_lr0.00025_40_hidden1408_mlp_1830_peval-wella-delta-Isotr\\[Space-Adapt-Space-FullA-Axial\\]-AdamW-0.00025/0/checkpoints/coalesced.pth"

...
#SBATCH --mem=0
#SBATCH --exclusive
#SBATCH -J grid30_lr0.0002_6_hidden928_mlp_416 
#SBATCH --output=/mnt/home/polymathic/ceph/MPPX_logging/runs/logs/slurmid%j--grid30_lr0.0002_6_hidden928_mlp_416.log
#SBATCH -C h100
...
srun python -u `which torchrun` \
		...
		--rdzv_endpoint=$SLURMD_NODENAME:29500 \
			train.py distribution=ddp ++experiment_dir=/mnt/home/polymathic/ceph/MPPX_logging/runs name=grid30_lr0.0002_6_hidden928_mlp_416 trainer.grad_acc_steps=4 server=rusty optimizer=adam optimizer.lr=0.0002 logger.wandb_project_name="MPPX_Scaling_Grid" \

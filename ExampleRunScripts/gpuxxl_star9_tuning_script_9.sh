...
python -u `which torchrun` \
		--nnodes=4 \
		--nproc_per_node=8 \
		--rdzv_id=star9_lr0.00025_8_hidden1408_mlp_5632 \
		--rdzv_backend=c10d \
		--rdzv_endpoint=${MASTER_ADDR}:29500 \
			train.py distribution=hsdp ++experiment_dir=/mnt/home/polymathic/ceph/MPPX_logging/runs name=star9_lr0.00025_8_hidden1408_mlp_5632_nodes_13-16 trainer.grad_acc_steps=5 server=gpuxl optimizer=adam optimizer.lr=0.00025 logger.wandb_project_name="MPPX_Scaling" \

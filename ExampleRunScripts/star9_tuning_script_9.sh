...
#SBATCH --mem=0
#SBATCH --exclusive
#SBATCH -J star9_lr0.00025_8_hidden1408_mlp_5632 
#SBATCH --output=slurmid%j-star9_lr0.00025_8_hidden1408_mlp_5632.log
#SBATCH -C h100|h200
...
srun --export=ALL env LD_LIBRARY_PATH=$LD_LIBRARY_PATH \
		...
		--rdzv_endpoint=$SLURMD_NODENAME:29500 \
			train.py distribution=fsdp ++experiment_dir=/mnt/home/polymathic/ceph/MPPX_logging/runs name=star9_lr0.00025_8_hidden1408_mlp_5632_nodes_13-16 trainer.grad_acc_steps=4 server=rusty experiment=validate_example checkpoint=defaults optimizer=adam optimizer.lr=0.00025 logger.wandb_project_name="MPPX_Scaling" \
				...
				model.projection_dim=48 model.intermediate_dim=352 model.hidden_dim=1408 model.groups=16 model.processor_blocks=8 model.drop_path=0.1 \
				...
				trainer.prediction_type="delta" data=all_2_3d_rusty trainer.video_validation=True trainer.max_epoch=101 data_workers=10 model.override_dimensionality=0 ++trainer.skip_spectral_metrics=True auto_resume=True \
				checkpoint.coalesced_checkpoint_path="/mnt/home/polymathic/ceph/MPPX_logging/runs/star9_lr0.00025_8_hidden1408_mlp_5632_nodes_13-16-wella-delta-Isotr\\[Space-Adapt-Space-FullA-Axial\\]-AdamW-0.00025/0/checkpoints/coalesced.pth"

...
#SBATCH --mem=0
#SBATCH --exclusive
#SBATCH -J star1_lr0.00025_40_hidden720_mlp_5632 
#SBATCH --output=logs/slurmid%j-star1_lr0.00025_40_hidden720_mlp_5632.log
...
python -u `which torchrun` \
		--nnodes=5 \
		--nproc_per_node=8 \
		--rdzv_id=star1_lr0.00025_40_hidden720_mlp_5632 \
		--rdzv_backend=c10d \
		--rdzv_endpoint=workergpu314:29500 \
			train.py distribution=hsdp name=star1_lr0.00025_40_hidden720_mlp_5632 trainer.grad_acc_steps=4 server=gpuxl optimizer=adam optimizer.lr=0.00025 logger.wandb_project_name="MPPX_Scaling" \
				...
				model.projection_dim=48 model.intermediate_dim=352 model.hidden_dim=720 model.groups=16 model.processor_blocks=40 model.drop_path=0.1 \

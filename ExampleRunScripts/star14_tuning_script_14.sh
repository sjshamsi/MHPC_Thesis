...
#SBATCH --mem=0
#SBATCH --exclusive
#SBATCH -J star14_lr0.00025_40_hidden1408_mlp_1056 
#SBATCH --output=validate_slurmid%j-star14_lr0.00025_40_hidden1408_mlp_1056.log
##SBATCH -C h200
...
srun --export=ALL env LD_LIBRARY_PATH=$LD_LIBRARY_PATH \
		...
		--rdzv_endpoint=$SLURMD_NODENAME:29500 \
			train.py distribution=fsdp ++experiment_dir=/mnt/home/polymathic/ceph/MPPX_logging/runs name=star14_lr0.00025_40_hidden1408_mlp_1056_peval trainer.grad_acc_steps=5 server=rusty experiment=validate_example checkpoint=defaults optimizer=adam optimizer.lr=0.00025 logger.wandb_project_name="MPPX_Scaling" \
				...
				model/processor/space_mixing=full_spatial_attention model.processor.space_mixing.mlp_dim=1056 model.processor.space_mixing.num_heads=16 model.processor.time_mixing.num_heads=16 \
				...
				trainer.prediction_type="delta" data=all_2_3d_rusty trainer.video_validation=True trainer.max_epoch=101 data_workers=10 model.override_dimensionality=0 ++trainer.skip_spectral_metrics=True auto_resume=False \
				checkpoint.coalesced_checkpoint_path="/mnt/home/polymathic/ceph/MPPX_logging/runs/star14_lr0.00025_40_hidden1408_mlp_1056_peval-wella-delta-Isotr\\[Space-Adapt-Space-FullA-Axial\\]-AdamW-0.00025/0/checkpoints/coalesced.pth"

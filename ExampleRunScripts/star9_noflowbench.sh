...
#SBATCH --mem=0
#SBATCH --exclusive
#SBATCH -J star9_lr0.00025_8_hidden1408_mlp_5632_noFlowBench 
#SBATCH --output=slurmid%j-star9_lr0.00025_8_hidden1408_mlp_5632_noFlowBench.log
#SBATCH -C h200
...
srun --export=ALL env LD_LIBRARY_PATH=$LD_LIBRARY_PATH \
		...
		--rdzv_endpoint=$SLURMD_NODENAME:29500 \
			train.py distribution=fsdp ++experiment_dir=/mnt/home/polymathic/ceph/MPPX_logging/runs name=star9_lr0.00025_8_hidden1408_mlp_5632_noFlowBench trainer.grad_acc_steps=5 server=gpuxl optimizer=adam optimizer.lr=0.00025 logger.wandb_project_name="MPPX_Scaling" \
				...
				trainer.prediction_type="delta" data=all_2_3d_rusty_xxl trainer.video_validation=False trainer.max_epoch=101 data_workers=10 model.override_dimensionality=0 ++trainer.skip_spectral_metrics=True auto_resume=True \

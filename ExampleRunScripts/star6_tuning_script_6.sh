...
#SBATCH --mem=0
#SBATCH --exclusive
#SBATCH -J star6_lr0.00025_16_hidden1408_mlp_5632 
#SBATCH --output=slurmid%j-star6_lr0.00025_16_hidden1408_mlp_5632.log
#SBATCH -C h100|h200
...
srun --export=ALL env LD_LIBRARY_PATH=$LD_LIBRARY_PATH \
		...
		--rdzv_endpoint=$SLURMD_NODENAME:29500 \
			train.py distribution=fsdp name=star6_lr0.00025_16_hidden1408_mlp_5632 trainer.grad_acc_steps=4 server=rusty experiment=validate_example checkpoint=defaults optimizer=adam optimizer.lr=0.00025 logger.wandb_project_name="MPPX_Scaling" \
				...
				model.projection_dim=48 model.intermediate_dim=352 model.hidden_dim=1408 model.groups=16 model.processor_blocks=16 model.drop_path=0.1 \
				...
				checkpoint.coalesced_checkpoint_path="/mnt/home/polymathic/ceph/MPPX_logging/NAIRR_coalesced/lr0.00025_16_hidden1408_mlp_5632-wella-delta-Isotr\\[Space-Adapt-Space-FullA-Axial\\]-AdamW-0.00025/coalesced_star6.pth"
